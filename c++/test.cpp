...
void sendHttpResponse(WiFiEspClient client){
  ...
  client.println("<title>MasterWalker Shop - Shield WiFi ESP8266 para Arduino</title>"); //ESCREVE O TEXTO NA PÁGINA
  ...
  client.println("<p style='line-height:2'><font>Shield WiFi ESP8266 para Arduino</font></p>"); //ESCREVE O TEXTO NA PÁGINA
  client.println("<p style='line-height:2'><font>(ESP8266 ESP-12E UART Wireless WIFI Shield TTL Converter)</font></p>"); //ESCREVE O TEXTO NA PÁGINA
